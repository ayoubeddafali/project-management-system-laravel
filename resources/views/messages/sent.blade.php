...
@section('content')
    ...
    <div id="content">
        ...
        <ul class="nav nav-tabs" style="  border: 0px hidden;">
            <li role="presentation" class="presentation" id="active_by_default"><a href="/messages/all">Received Messages</a></li>
            <li role="presentation" class="presentation active"><a href="/messages/sent">Sent Messages</a></li>
        </ul>
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">Messages / <small>Sent</h3>
            ...
            <div class="box-body table-responsive no-padding">
                <table  class="table table-hover" style="font-family:'Lucida Grande', sans-serif ">
                    ...
                    @foreach($inboxs as $inbox)
                        <tr>
                            <td>{{User::find($inbox->to)->email}}</td>
                            <td>{{ $inbox->subject }}</td>
                            <td>{{$inbox->content}}</td>
